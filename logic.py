...
import base64
# Import the circuit diagram generator
from CircuitDiagramGenerator import CircuitDiagramGenerator
...
def main(page: ft.Page):
    ...
    input_plot = ft.Image(src_base64="", width=600, height=250)
    output_plot = ft.Image(src_base64="", width=600, height=250)
    comparison_plot = ft.Image(src_base64="", width=600, height=300)
